                ...
                <div class="container">
                    <div class="row">
                        <div class="col-xs-10 col-xs-offset-1 col-sm-5 col-sm-offset-0">
                            <div class="well">
                                <h3 class="text-center" style="font-family: 'Lobster', cursive; font-size: 27px;">
                                    Dirección</h3>
                                <address>
                                    <strong>Pais:</strong> Bolivia<br>
                                    <strong>Dirección:</strong> Av. Los robles Zona sur XD<br>
                                    <strong>Ciudad:</strong> La Paz<br>
                                    <strong>Email:</strong> ElectroCarly@gmail.com
                                </address>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-7">
                            <div class="well">
                                ...
                                <address>
                                    ...
                                    <strong>WhatsApp:</strong> +591 71234567<br>
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-md-4 col-md-push-8">
                            <h2 class="tittles-pages text-center">💡 ¡Todo lo que necesitas en un solo lugar!</h2>
                            <p>
                                En <b>ElectroCarly</b>, estamos aquí para ayudarte. ¿Buscas accesorios para tu celular,
                                necesitas reparar tu dispositivo o tienes problemas con una entrega? Escríbenos a
                                nuestro correo ElectroCarly@gmail.com y recibe atención personalizada. Desde repuestos
                                originales hasta soluciones rápidas para tus pedidos, nuestro equipo está listo para
                                brindarte la mejor experiencia. ¡En ElectroCarly, resolver tus necesidades es nuestra
                                prioridad! 🚀
                            </p>
                        </div>
